...
export const TRAINER_NAV: NavItem[] = [
  ...
  { path: "/trainer/groups", label: "Gruppen", primary: true, owner: "WS-4" },
...
export const ADMIN_NAV: NavItem[] = [
  ...
  { path: "/admin/groups", label: "Gruppen", primary: true, owner: "WS-6" },
...
export const DYNAMIC_ROUTES: { path: string; owner: string }[] = [
  ...
  { path: "/trainer/groups/01980a30-0000-7000-8000-000000000001", owner: "WS-4" },
  ...
  { path: "/admin/groups/new", owner: "WS-6" },
];
